...
void TcpClientApp::initialize(int stage)
{
...
void TcpClientApp::handleStartOperation(LifecycleOperation *operation)
{
...
void TcpClientApp::handleStopOperation(LifecycleOperation *operation)
{
...
void TcpClientApp::handleCrashOperation(LifecycleOperation *operation)
{
    if (timeoutMsg != nullptr)
        cancelEvent(timeoutMsg);
    cancelEvent(readDelayTimer);
...
void TcpClientApp::handleTimer(cMessage *msg)
{
    switch (msg->getKind()) {
...
void TcpClientApp::socketEstablished(TcpSocket *socket)
{
...
void TcpClientApp::rescheduleAfterOrDeleteTimer(simtime_t d, short int msgKind)
{
...
void TcpClientApp::socketDataArrived(TcpSocket *socket, Packet *msg, bool urgent)
{
...
void TcpClientApp::socketClosed(TcpSocket *socket)
{
    cancelEvent(readDelayTimer);
...
void TcpClientApp::socketFailure(TcpSocket *socket, int code)
{
    cancelEvent(readDelayTimer);
...
void TcpClientApp::sendOrScheduleReadCommandIfNeeded()
{
