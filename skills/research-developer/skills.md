...
## Output standards 
- Both in chat outputs and .md documents, any fact from the outside MUST be cited, with direct links provided for easy inspection and fact checking.

- In the end of both chat outputs and generated .md documents, a list of glossory SHOULD be provided.

- Mathematical formula SHOULD be provided with LaTeX format for quick reuse.
